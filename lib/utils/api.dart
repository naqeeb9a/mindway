const String baseURL = 'https://mindwayadmin.com';
const String apiURL = '$baseURL/api/customer';
const String imgAndAudio = '$baseURL/storage/app';
const String sessionURL = '$imgAndAudio/sessions';
const String emojiURL = '$imgAndAudio/emoji';
